...
def test_the_identity_prefix_says_these_things_in_this_order(
    ...
    _assert_in_order(prefix, opening, *filter(None, (offer,)), "call plow_offer_invite",
                     # Both Latch clauses are load-bearing and were added from
                     # transcript evidence: the agent waited to be told which
                     # route to take (12 times in a week), and never once told
                     # anyone their Mac had to be awake (0 in 21k messages).
