...
LATCH_PROMPT = (
    ...
    "work only. Texting a person is the exception: call plow_list_chats first, and if they are in one "
    "of your Plow chats send it with plow_send_message — only fall back to the Mac's Messages app "
    "(plow_run_applescript, which runs outside the sandbox) when they are in none. "
