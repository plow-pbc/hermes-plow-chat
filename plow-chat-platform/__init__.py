...
LATCH_PROMPT = (
    ...
    "work only. For your owner's own requests, texting a person is the exception: call plow_list_chats "
    ...
    "Mac. The same holds for your own actions, and for everyone in the room, not only your owner: you "
